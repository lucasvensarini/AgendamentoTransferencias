...
public class Main {
	...
	public static void main(String[] args) {
		...
		Usuario tais = new Usuario("Tais");

		Conta conta = new Conta("12345-6", lucas);

		TransferenciaBase transferencia1 = new TransferenciaBase(conta, new Conta("78901-2", tais),
				BigDecimal.valueOf(-1500.752312121), LocalDateTime.of(2016, 10, 25, 15, 30));
		ITransferencia transfercenciaA = new TransferenciaA(transferencia1);

		TransferenciaBase transferencia2 = new TransferenciaBase(conta, new Conta("78901-2", tais),
				BigDecimal.valueOf(100), LocalDateTime.of(2016, 11, 30, 15, 30));
		ITransferencia transfercenciaB = new TransferenciaB(transferencia2);

		TransferenciaBase transferencia3 = new TransferenciaBase(conta, new Conta("78901-2", tais),
		...
		TransferenciaBase transferencia4 = new TransferenciaBase(conta, new Conta("78901-2", tais),
		...
		TransferenciaBase transferencia5 = new TransferenciaBase(conta, new Conta("78901-2", tais),
		...
		TransferenciaBase transferencia6 = new TransferenciaBase(conta, new Conta("78901-2", tais),
